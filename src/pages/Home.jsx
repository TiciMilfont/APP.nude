...
import Login from './Login'; // Import correto do Login dentro da pasta pages
...
function Home({ 
  ...
  return (
    <div className="pagina-container-modelo">
      ...
      {/* 1. TOPO: HEADER (ESQUERDA) + LOGIN (DIREITA) */}
      <div className="grid-topo-modelo">
        ...
        <div className="bloco-login-direita">
          <Login />
        </div>
      </div>
      ...
      {/* 4. RODAPÉ: EQUIPE (INFERIOR ESQUERDO) + CARRINHO (INFERIOR DIREITO) */}
      <div className="grid-rodape-modelo">
